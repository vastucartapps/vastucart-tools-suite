...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: locale === 'en' ? '/tools/chaldean-numerology' : `/${locale}/tools/chaldean-numerology`,
      languages: {
    ...
    openGraph: {
      ...
      siteName: 'VastuCart',
      images: [{
        url: `https://www.vastucart.in/images/blog/chaldean-numerology/hero.webp`,
        width: 1200,
        height: 630,
        alt: t('meta.title'),
      }],
    ...
    twitter: {
      ...
      title: t('meta.title'),
      description: t('meta.description'),
      images: [`https://www.vastucart.in/images/blog/chaldean-numerology/hero.webp`],
    },
  };
}
