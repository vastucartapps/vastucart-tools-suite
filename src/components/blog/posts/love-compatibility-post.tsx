    ...
    <article className="prose prose-lg max-w-none">
      ...
      <div className="bg-gradient-to-br from-teal-50 to-saffron-50 rounded-2xl p-8 mb-12 border border-teal-100">
        <p className="text-xl text-gray-700 mb-6 leading-relaxed">
          <strong className="text-teal-800">&quot;Are we meant to be together? Will this relationship work?&quot;</strong>
        </p>
        <p className="text-gray-700 mb-6">
          Here&apos;s what lovers rarely know: <strong className="text-teal-700">Your compatibility with another person can be predicted through numerology with surprising accuracy.</strong>
        </p>

        <div className="bg-white/80 rounded-xl p-5 border border-teal-100 mb-6">
          <h4 className="font-bold text-teal-800 mb-3">Your Love Compatibility is calculated by comparing:</h4>
        ...
        <HighlightBox type="tip">
          <p className="font-bold text-teal-800 mb-2">The Power of Compatibility</p>
      ...
      <section id="what-is-compatibility" className="mb-16 scroll-mt-24">
        ...
        <p className="text-gray-700 mb-6">
          Your <Link href={`/${locale}/tools/love-compatibility`} className="text-saffron-600 hover:underline font-semibold">Love Compatibility</Link> measures how well two people&apos;s numerological vibrations align.
        </p>
        ...
        <InfoCard title="How It Works" variant="teal">
          ...
          <ol className="space-y-2 text-sm text-gray-700">
            <li className="flex items-start gap-2">
              <span className="w-6 h-6 flex items-center justify-center rounded-full bg-teal-500 text-white text-xs font-bold flex-shrink-0">1</span>
              <span><strong>Life Path Numbers</strong> - Core personality match</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-6 h-6 flex items-center justify-center rounded-full bg-teal-500 text-white text-xs font-bold flex-shrink-0">2</span>
              <span><strong>Expression Numbers</strong> - Communication style match</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-6 h-6 flex items-center justify-center rounded-full bg-teal-500 text-white text-xs font-bold flex-shrink-0">3</span>
              <span><strong>Soul Urge Numbers</strong> - Desire/motivation match</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="w-6 h-6 flex items-center justify-center rounded-full bg-teal-500 text-white text-xs font-bold flex-shrink-0">4</span>
              <span><strong>Combined Number</strong> - Relationship destiny</span>
            </li>
          </ol>
          <p className="text-teal-700 mt-4 font-medium">Together, these create compatibility score (0-100%).</p>
        </InfoCard>
      ...
      <section id="how-to-calculate" className="mb-16 scroll-mt-24">
        ...
        <div className="space-y-6 my-8">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-6 border border-teal-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-teal-800 mb-2">Calculate Both Life Path Numbers</h4>
                ...
                <div className="bg-white/80 rounded-lg p-4 font-mono text-sm">
                  ...
                  <p className="text-teal-700 font-bold mt-2">Total: 3 + 6 + 1 = 10 = 1 (Life Path = 1)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-6 border border-saffron-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-saffron-800 mb-2">Calculate Soul Urge Numbers</h4>
                ...
                <div className="bg-white/80 rounded-lg p-4 font-mono text-sm">
                  ...
                  <p className="text-saffron-700 font-bold mt-2">Soul Urge = 6</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-teal-600 to-saffron-500 rounded-2xl p-8 text-center my-8">
          ...
          <p className="text-teal-50 mb-6">Discover your relationship destiny through numerology</p>
          <Link
            href={`/${locale}/tools/love-compatibility`}
      ...
      <section id="perfect-matches" className="mb-16 scroll-mt-24">
        ...
        <div className="space-y-6 my-8">
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-2xl p-6 border-2 border-saffron-400">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-saffron-800 text-xl">3 + 6: Creative & Nurturing</h3>
              <span className="bg-saffron-500 text-white font-bold px-4 py-2 rounded-full">88%</span>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white/80 rounded-xl p-4">
                <h4 className="font-semibold text-saffron-800 mb-2">Why it works:</h4>
                <ul className="text-sm text-gray-700 space-y-1">
              ...
              <div className="bg-white/80 rounded-xl p-4">
                <h4 className="font-semibold text-saffron-800 mb-2">Relationship style:</h4>
                <ul className="text-sm text-gray-700 space-y-1">
            ...
            <p className="text-saffron-700 mt-4 font-medium">Challenges: Minor (3 can scatter, 6 can worry)</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-6 my-8">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-6 border border-teal-200">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-bold text-teal-800">Understand Differences</h4>
            </div>
            ...
            <div className="bg-white/80 rounded-lg p-3 text-sm">
              ...
              <p className="text-teal-700 font-medium">Together = balance</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-6 border border-saffron-200">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 flex items-center justify-center rounded-full bg-saffron-500 text-white">
                <Calendar className="w-5 h-5" />
              </div>
              <h4 className="font-bold text-saffron-800">Create Rituals Together</h4>
            </div>
      ...
      <section id="faqs" className="mb-16 scroll-mt-24">
        ...
        <div className="space-y-4">
          <InfoCard title="If compatibility is low, should we break up?" variant="teal">
            ...
            <FeatureList
              ...
              variant="check"
            />
            <p className="text-teal-700 mt-3 font-medium">True love transcends numbers.</p>
          </InfoCard>
          ...
          <InfoCard title="If I'm incompatible, can I change my name?" variant="highlight">
            ...
            <p className="text-teal-700 font-medium">Better approach: Work on understanding differences, strengthen communication, deepen love.</p>
          </InfoCard>

          <InfoCard title="Are soulmates real according to numerology?" variant="teal">
            ...
            <p className="text-teal-700 mt-3 font-medium">Numerology shows potential. Love creates destiny.</p>
          </InfoCard>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-saffron-300" /> Natural harmony</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-saffron-300" /> Effortless understanding</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-saffron-300" /> Mutual growth</li>
              </ul>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
              <p className="font-bold text-white mb-2">Building Destiny Together:</p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-saffron-300" /> Conscious effort</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-saffron-300" /> Deep understanding</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-saffron-300" /> Chosen love</li>
              </ul>
            </div>
          </div>
      ...
      <section className="mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <Link href={`/${locale}/tools/lucky-color`} className="block bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-4 border border-saffron-200 hover:shadow-md transition-shadow">
            <h4 className="font-bold text-saffron-800 mb-1">Lucky Color Calculator</h4>
