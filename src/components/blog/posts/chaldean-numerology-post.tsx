  ...
  return (
    <div className="space-y-8">
      ...
      <HighlightBox type="important">
        <p className="text-lg font-bold text-teal-800 mb-2">The Numerology Confusion Everyone Faces</p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-5 border border-teal-200">
          <h3 className="font-bold text-teal-800 text-lg mb-2">Chaldean Numerology</h3>
          <p className="text-sm text-teal-600 mb-2">Ancient Babylon (~500 BCE)</p>
          <p className="text-sm text-gray-700">More accurate for name analysis & vibration</p>
          <p className="text-xs text-teal-700 mt-2 font-medium">Recommended for most people</p>
        </div>
        <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-5 border border-saffron-200">
          <h3 className="font-bold text-saffron-800 text-lg mb-2">Pythagorean Numerology</h3>
          <p className="text-sm text-saffron-600 mb-2">Ancient Greece (~550 BCE)</p>
          <p className="text-sm text-gray-700">Better for personality analysis & basic life path</p>
          <p className="text-xs text-saffron-700 mt-2 font-medium">Easier to learn</p>
        </div>
      </div>
      ...
      <section id="quick-comparison">
            ...
            <tbody>
              {[
                ...
                <tr key={i} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  ...
                  <td className="px-4 py-3 text-teal-700">{row.chaldean}</td>
                  <td className="px-4 py-3 text-saffron-700">{row.pythagorean}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="mt-6 bg-gradient-to-br from-cream-50 to-cream-100 rounded-2xl p-6 border border-cream-200">
          <h3 className="font-bold text-teal-800 text-lg mb-4">Quick Example: Name &quot;JOHN SMITH&quot;</h3>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-teal-50 rounded-xl p-4 border border-teal-200">
              <p className="font-bold text-teal-800 mb-2">Chaldean System:</p>
              <p className="font-mono text-xs text-gray-700 mb-2">J(1) O(7) H(5) N(5) S(3) M(4) I(1) T(4) H(5)</p>
              <p className="font-mono text-sm text-teal-700">= 35 = 3+5 = <strong>Destiny 8</strong></p>
            </div>
            <div className="bg-saffron-50 rounded-xl p-4 border border-saffron-200">
              <p className="font-bold text-saffron-800 mb-2">Pythagorean System:</p>
              <p className="font-mono text-xs text-gray-700 mb-2">J(1) O(6) H(8) N(5) S(1) M(4) I(9) T(2) H(8)</p>
              <p className="font-mono text-sm text-saffron-700">= 44 = 4+4 = <strong>Destiny 8</strong></p>
            </div>
          </div>
      ...
      <section id="how-to-calculate">
        ...
        {/* Chaldean Table */}
        <div className="mt-6">
          <h3 className="font-bold text-teal-800 text-lg mb-3">Chaldean System: Letter Values</h3>
          <div className="overflow-x-auto">
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-4 border border-teal-200">
              <div className="grid grid-cols-9 gap-1 text-center text-sm">
                <div className="font-bold text-teal-800 col-span-9 mb-2">Numbers 1-8 (No 9 in Chaldean)</div>
                {['1', '2', '3', '4', '5', '6', '7', '8', ''].map((n, i) => (
                  <div key={i} className="bg-teal-600 text-white font-bold py-1 rounded">{n}</div>
                ))}
                {['A,I,J,Q,Y', 'B,K,R', 'C,G,L,S', 'D,M,T', 'E,H,N,X', 'U,V,W', 'O,Z', 'F,P', ''].map((letters, i) => (
                  <div key={i} className="bg-white py-2 text-xs text-gray-700 rounded border border-teal-100">{letters}</div>
                ))}
              </div>
              <p className="text-xs text-teal-700 mt-3 italic">Based on sound vibrations, not alphabet position. No 9 (too sacred).</p>
            </div>
          </div>
        </div>
        ...
        {/* Pythagorean Table */}
        <div className="mt-6">
          <h3 className="font-bold text-saffron-800 text-lg mb-3">Pythagorean System: Letter Values</h3>
          <div className="overflow-x-auto">
            <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-4 border border-saffron-200">
              <div className="grid grid-cols-9 gap-1 text-center text-sm">
                <div className="font-bold text-saffron-800 col-span-9 mb-2">Numbers 1-9 (Sequential)</div>
                {['1', '2', '3', '4', '5', '6', '7', '8', '9'].map((n, i) => (
                  <div key={i} className="bg-saffron-600 text-white font-bold py-1 rounded">{n}</div>
                ))}
                {['A,J,S', 'B,K,T', 'C,L,U', 'D,M,V', 'E,N,W', 'F,O,X', 'G,P,Y', 'H,Q,Z', 'I,R'].map((letters, i) => (
                  <div key={i} className="bg-white py-2 text-xs text-gray-700 rounded border border-saffron-100">{letters}</div>
                ))}
              </div>
              <p className="text-xs text-saffron-700 mt-3 italic">Simple sequential mapping (A=1, B=2... I=9, J=1...). Easy to learn.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl p-6 border border-amber-200">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white/80 rounded-xl p-4">
              <p className="font-bold text-teal-700 mb-2">Chaldean:</p>
              <p className="font-mono text-sm text-gray-700">K(2) A(1) T(4) R(2) I(1) N(5) A(1) = 16 = 7</p>
              <p className="text-sm text-teal-700 mt-1"><strong>Destiny 7</strong> = Seeker, spiritual</p>
            </div>
            <div className="bg-white/80 rounded-xl p-4">
              <p className="font-bold text-saffron-700 mb-2">Pythagorean:</p>
              <p className="font-mono text-sm text-gray-700">K(2) A(1) T(2) R(9) I(9) N(5) A(1) = 29 = 11 = 2</p>
              <p className="text-sm text-saffron-700 mt-1"><strong>Destiny 2</strong> = Diplomat, cooperative</p>
            </div>
          </div>
      ...
      <section id="differences">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-5 border border-teal-200">
            <h3 className="font-bold text-teal-800 mb-3">Chaldean Philosophy</h3>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-5 border border-saffron-200">
            <h3 className="font-bold text-saffron-800 mb-3">Pythagorean Philosophy</h3>
            <ul className="space-y-2 text-sm text-gray-700">
        ...
        <h3 className="text-xl font-bold text-teal-800 mt-8 mb-4">Letters That Cause Conflicts</h3>
        <div className="overflow-x-auto">
          <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm">
            <thead>
            ...
            <tbody>
              {[
                ...
                <tr key={i} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  ...
                  <td className="px-4 py-3 text-center text-teal-700 font-bold">{row.chaldean}</td>
                  <td className="px-4 py-3 text-center text-saffron-700 font-bold">{row.pythagorean}</td>
      ...
      <section id="accuracy">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-teal-500 to-teal-700 rounded-2xl p-6 text-white shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-teal-100 text-sm">Professional-grade precision</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-saffron-500 to-saffron-700 rounded-2xl p-6 text-white shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-saffron-100 text-sm">Good for beginners</p>
              </div>
            </div>
            <ul className="space-y-2 text-sm">
        ...
        <div className="mt-6 bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl p-6 border border-amber-200">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white/80 rounded-xl p-4">
              <p className="font-bold text-teal-700 mb-2">Chaldean: Destiny 8</p>
              <p className="text-sm text-gray-700">Power, wealth, achievement</p>
              <p className="text-xs text-teal-600 mt-2 italic">Perfectly matches her empire-building</p>
            </div>
            <div className="bg-white/80 rounded-xl p-4">
              <p className="font-bold text-saffron-700 mb-2">Pythagorean: Destiny 1</p>
              <p className="text-sm text-gray-700">Independence, leadership</p>
              <p className="text-xs text-saffron-600 mt-2 italic">Also matches, different emphasis</p>
            </div>
          </div>
      ...
      <section id="origins">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
            <h3 className="font-bold text-teal-800 text-xl mb-4">Chaldean Numerology</h3>
            <p className="text-sm text-teal-600 mb-4">Ancient Babylon (~500 BCE)</p>

            <div className="space-y-4">
              <div>
                <p className="font-semibold text-teal-800 mb-1">Origins:</p>
              ...
              <div>
                <p className="font-semibold text-teal-800 mb-1">Philosophy:</p>
                <ul className="text-sm text-gray-700 space-y-1">
              ...
              <p className="text-xs text-teal-700 italic">Famous practitioners: Kabbalah mystics, Vedic scholars</p>
            </div>
          </div>

          {/* Pythagorean Origins */}
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-2xl p-6 border border-saffron-200">
            <h3 className="font-bold text-saffron-800 text-xl mb-4">Pythagorean Numerology</h3>
            <p className="text-sm text-saffron-600 mb-4">Ancient Greece (~550 BCE)</p>

            <div className="space-y-4">
              <div>
                <p className="font-semibold text-saffron-800 mb-1">Origins:</p>
                <ul className="text-sm text-gray-700 space-y-1">
              ...
              <div>
                <p className="font-semibold text-saffron-800 mb-1">Philosophy:</p>
                <ul className="text-sm text-gray-700 space-y-1">
              ...
              <p className="text-xs text-saffron-700 italic">Famous practitioners: Mathematicians, Western astrologers</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
            ...
            <FeatureList
              ...
              variant="check"
            />
            <p className="text-sm text-teal-700 mt-4 font-medium">Best for: Advanced practitioners, name corrections, serious seekers</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-2xl p-6 border border-saffron-200">
            ...
            <FeatureList
              ...
              variant="check"
            />
            <p className="text-sm text-saffron-700 mt-4 font-medium">Best for: Beginners, quick readings, personality exploration</p>
          </div>
        </div>

        {/* Recommendation */}
        <HighlightBox type="tip">
          <p className="text-lg font-bold text-teal-800 mb-2">My Recommendation: Learn BOTH</p>
        ...
        <div className="bg-gradient-to-br from-teal-600 to-teal-800 rounded-2xl p-8 text-white shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="bg-white/10 rounded-xl p-4">
              ...
              <p className="text-sm text-teal-100">Professional-grade accuracy (like medical imaging)</p>
            </div>
            <div className="bg-white/10 rounded-xl p-4">
              <p className="font-bold text-white mb-2">Pythagorean</p>
              <p className="text-sm text-teal-100">Consumer-grade simplicity (like health trackers)</p>
            </div>
          </div>
          ...
          <div className="bg-white/10 rounded-xl p-5">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-teal-100"><strong className="text-white">Option 1:</strong> Use Pythagorean, get 78% accuracy</p>
              <p className="text-teal-100"><strong className="text-white">Option 2:</strong> Study Chaldean, get 92% accuracy</p>
              <p className="text-saffron-300"><strong className="text-white">Option 3:</strong> Master both, become an expert</p>
            </div>
          </div>

          <p className="text-lg font-medium text-center text-saffron-300 mt-6">
