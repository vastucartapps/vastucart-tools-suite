    ...
    <article className="prose prose-lg max-w-none">
      ...
      <div className="bg-gradient-to-br from-teal-50 to-amber-50 rounded-2xl p-8 mb-12 border border-teal-100">
        <p className="text-xl text-gray-700 leading-relaxed mb-6">
          <strong className="text-teal-800">&quot;Why does my room feel draining? How can I optimize my space?&quot;</strong>
        </p>
        ...
        <p className="text-gray-700 mb-4">
          Your <Link href={`/${locale}/tools/room-advisor`} className="text-saffron-600 hover:underline font-semibold">Room&apos;s Energy</Link> depends on:
        </p>
        <div className="grid md:grid-cols-5 gap-3">
          {[
            ...
            <div key={idx} className="bg-white/70 rounded-lg p-3 text-center">
              <item.icon className="w-5 h-5 mx-auto text-teal-600 mb-1" />
      ...
      <HighlightBox type="tip">
        ...
        <p className="mt-3 font-medium text-teal-700">This isn&apos;t psychology. It&apos;s Vastu science.</p>
      </HighlightBox>
      ...
      <section id="what-is-vastu" className="scroll-mt-24">
        ...
        <InfoCard title="Core Principles" variant="teal">
          <p className="text-gray-700 mb-4">Vastu works with:</p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white/60 rounded-lg p-3">
              <p className="font-bold text-teal-700">🌍 The 5 Elements</p>
              <p className="text-sm text-gray-600">Earth, Water, Fire, Air, Space</p>
            </div>
            <div className="bg-white/60 rounded-lg p-3">
              <p className="font-bold text-teal-700">🧭 The 8 Directions</p>
              <p className="text-sm text-gray-600">North, South, East, West + diagonals</p>
            </div>
            <div className="bg-white/60 rounded-lg p-3">
              <p className="font-bold text-teal-700">✨ Energy Flow</p>
              <p className="text-sm text-gray-600">Natural life force (prana) movement</p>
            </div>
            <div className="bg-white/60 rounded-lg p-3">
              <p className="font-bold text-teal-700">⚖️ Balance</p>
              <p className="text-sm text-gray-600">Masculine & Feminine energy</p>
            </div>
          </div>
          <p className="text-teal-700 mt-4 font-medium italic">When these align, space thrives. When misaligned, space struggles.</p>
        </InfoCard>

        <InfoCard title="How It Works" variant="saffron">
          ...
          <FeatureList
            ...
            variant="check"
          />
          <p className="text-saffron-700 mt-4 font-medium">Vastu positioning uses these for optimal results.</p>
        </InfoCard>
      ...
      <section id="elements-directions" className="scroll-mt-24">
        ...
        <h3 className="text-xl font-bold text-teal-700 mb-4">The 5 Elements in Vastu</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 my-8">
          {elements.map((element) => {
            ...
            const colorMap: Record<string, { bg: string; border: string; icon: string; text: string }> = {
              ...
              teal: { bg: 'from-teal-50 to-teal-100', border: 'border-teal-200', icon: 'from-teal-500 to-teal-600', text: 'text-teal-800' },
              orange: { bg: 'from-orange-50 to-orange-100', border: 'border-orange-200', icon: 'from-orange-500 to-orange-600', text: 'text-orange-800' },
              saffron: { bg: 'from-saffron-50 to-saffron-100', border: 'border-saffron-200', icon: 'from-saffron-500 to-saffron-600', text: 'text-saffron-800' }
            };
        ...
        <h3 className="text-xl font-bold text-teal-700 mb-4">The 8 Directions</h3>
            ...
            <tbody>
              {directions.map((dir, idx) => (
                <tr key={dir.direction} className={idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  <td className="px-4 py-3 font-bold text-teal-700">{dir.direction}</td>
      ...
      <section id="bedroom-vastu" className="scroll-mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-5 border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-2">👍 GOOD: West Side</h4>
        ...
        <InfoCard title="Bed Placement" variant="teal">
          <h4 className="font-bold text-teal-700 mb-3">CORRECT Placement:</h4>
          <FeatureList
            items={[
        ...
        <div className="my-8">
          <h4 className="font-bold text-teal-700 mb-4">Furniture Placement</h4>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm">
              <thead>
      ...
      <section id="office-vastu" className="scroll-mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-5 border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-2">👍 GOOD: East Side</h4>
            <ul className="text-sm text-teal-700 space-y-1">
              <li>• New ideas</li>
              <li>• Fresh energy</li>
        ...
        <InfoCard title="Desk Placement" variant="saffron">
          <h4 className="font-bold text-saffron-700 mb-3">CORRECT Placement:</h4>
          <FeatureList
            items={[
        ...
        <div className="grid md:grid-cols-3 gap-4 my-8">
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-5 border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-3">📈 For Productivity</h4>
            <ul className="text-sm text-teal-700 space-y-1">
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-5 border border-saffron-200">
            <h4 className="font-bold text-saffron-800 mb-3">🤝 For Clients</h4>
      ...
      <section id="living-room" className="scroll-mt-24">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl p-5 border border-teal-200">
            <h4 className="font-bold text-teal-800 mb-2">👍 GOOD: East</h4>
            <ul className="text-sm text-teal-700 space-y-1">
        ...
        <InfoCard title="Sofa Placement" variant="teal">
          <h4 className="font-bold text-teal-700 mb-3">CORRECT Placement:</h4>
          <FeatureList
            items={[
            ...
            variant="check"
          />
          <p className="text-teal-700 mt-3 text-sm"><strong>Why Northeast view:</strong> Prosperity direction, positive energy</p>
        </InfoCard>
        ...
        <div className="grid md:grid-cols-2 gap-6 my-8">
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-saffron-100 rounded-xl p-6 border border-saffron-200">
            <h4 className="font-bold text-saffron-800 mb-4 flex items-center gap-2">
              <Music className="w-5 h-5" />
              Music System
            </h4>
            <ul className="space-y-2 text-saffron-700">
      ...
      <section id="colors" className="scroll-mt-24">
        ...
        <div className="overflow-x-auto my-8">
          <table className="w-full border-collapse bg-white rounded-xl overflow-hidden shadow-sm">
            <thead>
              <tr className="bg-gradient-to-r from-saffron-500 to-amber-600 text-white">
            ...
            <tbody>
              {roomColors.map((room, idx) => (
                <tr key={room.room} className={idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  <td className="px-4 py-3 font-bold text-teal-700">{room.room}</td>
      ...
      <section id="conclusion" className="scroll-mt-24">
        ...
        <div className="bg-gradient-to-br from-teal-50 via-amber-50 to-saffron-50 rounded-2xl p-8 border border-teal-200">
          ...
          {/* Timeline */}
          <div className="mt-6 bg-gradient-to-r from-teal-100 to-amber-100 rounded-xl p-4">
            ...
            <div className="grid grid-cols-4 gap-2 text-center text-sm">
              <div className="bg-white rounded-lg p-2">
                <p className="font-bold text-teal-700">Week 1-2</p>
                <p className="text-gray-600">Subtle shifts</p>
              </div>
              <div className="bg-white rounded-lg p-2">
                <p className="font-bold text-teal-700">Week 3-4</p>
              ...
              <div className="bg-white rounded-lg p-2">
                <p className="font-bold text-saffron-700">Month 3+</p>
      ...
      <div className="mt-12 bg-gradient-to-r from-teal-600 to-amber-600 rounded-2xl p-8 text-center text-white">
        ...
        <p className="text-teal-100 mb-6">Discover optimal layout for your specific room</p>
        <Link
      ...
      <div className="mt-12 bg-gradient-to-br from-cream-50 to-teal-50 rounded-2xl p-8 border border-teal-100">
        <h3 className="text-xl font-bold text-teal-800 mb-6">Related Tools</h3>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href={`/${locale}/tools/house-number`} className="bg-white rounded-xl p-4 border border-teal-200 hover:shadow-md transition-shadow group">
            <h4 className="font-bold text-teal-700 group-hover:text-saffron-600 transition-colors">House Number</h4>
