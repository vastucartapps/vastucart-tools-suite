  ...
  return (
    <div className="space-y-8">
      ...
      <HighlightBox type="important">
        <p className="text-lg font-bold text-deepteal-800 mb-2">Is This Year Lucky For You?</p>
      ...
      {/* Benefits */}
      <InfoCard title="Understanding Your Bhagyodaya Year Helps You:" variant="deepteal">
        <FeatureList
          items={[
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-xl p-4 border border-deepteal-200">
          <p className="font-bold text-deepteal-800 mb-1">Personal Year 8</p>
          <p className="text-xs text-deepteal-600 mb-2">Money & Power Year</p>
        ...
        <div className="bg-gradient-to-br from-warmaccent-50 to-warmaccent-100 rounded-xl p-4 border border-warmaccent-200">
          <p className="font-bold text-warmaccent-800 mb-1">Personal Year 3</p>
          <p className="text-xs text-warmaccent-600 mb-2">Creativity Year</p>
      ...
      <section id="what-is-bhagyodaya">
        ...
        <div className="mt-6 space-y-4">
          <p className="text-gray-700 leading-relaxed">
            Your <strong className="text-deepteal-700">Bhagyodaya Year</strong> (Bhagya = Fortune, Udaya = Rising) is the numerological vibration of the current calendar year matched with your personal energy.
          </p>

          <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-xl p-5 border border-deepteal-200">
            <h3 className="font-bold text-deepteal-800 mb-3">How It Works:</h3>
          ...
          <div className="bg-gradient-to-br from-warmaccent-50 to-warmaccent-100 rounded-xl p-5 border border-warmaccent-200">
            <h3 className="font-bold text-warmaccent-800 mb-3">The 9-Year Cycle:</h3>
            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              {[
                ...
                <div key={i} className="bg-white/80 rounded-lg p-2">
                  <div className="font-bold text-warmaccent-700 text-lg">{year.num}</div>
                  <div className="text-gray-600">{year.theme}</div>
                </div>
              ))}
            </div>
            <p className="text-xs text-warmaccent-700 mt-3 text-center italic">Then the cycle repeats</p>
          </div>
        </div>
      </section>
      ...
      <section id="how-to-calculate">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-2xl p-6 border border-deepteal-200">
            <h3 className="font-bold text-deepteal-800 text-lg mb-4">Example: Born December 15, calculating for 2026</h3>
            <div className="bg-white/80 rounded-lg p-4 font-mono text-sm space-y-2">
              ...
              <p className="pt-2 border-t border-deepteal-200 text-deepteal-700">
                Total: 3 + 6 + 1 = 10 = 1 + 0 = <strong className="text-lg">Personal Year 1</strong>
              </p>
            </div>
            <p className="text-sm text-deepteal-700 mt-3">This person&apos;s 2026 = Year 1 (New Beginnings)</p>
          </div>
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-xl p-5 border border-deepteal-200">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-deepteal-600 text-white font-bold text-xl flex-shrink-0">1</div>
              <div className="flex-1">
                <h3 className="font-bold text-deepteal-800 text-lg">New Beginnings</h3>
                <p className="text-xs text-deepteal-600 mb-2">Energy: Birth, initiation, independence</p>
          ...
          <div className="bg-gradient-to-br from-warmaccent-50 to-warmaccent-100 rounded-xl p-5 border border-warmaccent-200">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-warmaccent-600 text-white font-bold text-xl flex-shrink-0">2</div>
              <div className="flex-1">
                <h3 className="font-bold text-warmaccent-800 text-lg">Partnerships & Cooperation</h3>
                <p className="text-xs text-warmaccent-600 mb-2">Energy: Duality, partnership, patience</p>
          ...
          <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-xl p-5 border border-deepteal-200">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-deepteal-600 text-white font-bold text-xl flex-shrink-0">5</div>
              <div className="flex-1">
                <h3 className="font-bold text-deepteal-800 text-lg">Freedom & Change</h3>
                <p className="text-xs text-deepteal-600 mb-2">Energy: Freedom, adventure, flexibility</p>
          ...
          <div className="bg-gradient-to-br from-warmaccent-50 to-warmaccent-100 rounded-xl p-5 border border-warmaccent-200">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-warmaccent-600 text-white font-bold text-xl flex-shrink-0">6</div>
              <div className="flex-1">
                <h3 className="font-bold text-warmaccent-800 text-lg">Responsibility & Family</h3>
                <p className="text-xs text-warmaccent-600 mb-2">Energy: Service, responsibility, harmony</p>
            ...
            <tbody>
              {[
                ...
                <tr key={i} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  <td className="px-4 py-3 font-bold text-deepteal-700">{row.year}</td>
      ...
      <section id="best-actions">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          {/* Year 1 Actions */}
          <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-xl p-5 border border-deepteal-200">
            <h3 className="font-bold text-deepteal-800 text-lg mb-3">Year 1: ACTION PLAN</h3>
