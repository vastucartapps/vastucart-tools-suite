    ...
    <div className="space-y-8">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-lg text-gray-700 leading-relaxed">
          ...
          That's <strong className="text-deepteal-700">Lagna</strong>—not the full picture of who you are, but how the world perceives you in that first moment.
        </p>

        <p className="text-gray-700 leading-relaxed">
          Your <strong className="text-deepteal-700">Lagna (Ascendant or Rising Sign)</strong> is the zodiac sign that was rising on the eastern horizon at the exact moment you were born.
        ...
        <p className="text-gray-700 leading-relaxed">
          Many people think they understand themselves by their Sun sign or Moon sign alone. But without understanding their <strong className="text-deepteal-700">Lagna</strong>, they miss the crucial "first layer" that governs:
        </p>
      ...
      <section id="what-is-lagna">
        ...
        <div className="prose prose-lg max-w-none mb-6">
          <p className="text-gray-700 leading-relaxed">
            Your <strong className="text-deepteal-700">Lagna (Ascendant/Rising Sign)</strong> is the zodiac sign that was on the <strong>eastern horizon at your exact birth time</strong>.
          </p>
        ...
        <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-2xl p-6 border border-deepteal-200 shadow-sm mb-6">
          <h3 className="font-bold text-deepteal-800 text-lg mb-4">
            Why Lagna Matters Most in Vedic Astrology
          </h3>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-deepteal-600 text-white flex-shrink-0">
                <Target className="w-4 h-4" />
              </div>
              <div>
                <p className="font-semibold text-deepteal-800 mb-1">It's Your Chart's Foundation</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-deepteal-800 mb-1">It Governs First Impressions</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-deepteal-800 mb-1">It Shapes Your Instinctive Response</p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-deepteal-800 mb-1">It Determines Physical Traits</p>
        ...
        <HighlightBox type="note">
          <h4 className="font-bold text-deepteal-800 mb-2">Lagna is the "Mask" You Wear</h4>
          ...
          <ul className="space-y-1 text-sm text-gray-700 mb-0">
            <li><strong className="text-deepteal-700">Lagna (Ascendant):</strong> Your public persona, how others see you</li>
            <li><strong className="text-deepteal-700">Moon Sign (Rashi):</strong> Your inner emotional world, your true feelings</li>
            <li><strong className="text-deepteal-700">Sun Sign:</strong> Your core identity, your life purpose</li>
          </ul>
          <p className="text-gray-700 mt-3 mb-0 italic">
            Most people only know their Sun sign and feel confused when it doesn't match their actual behavior. The answer is your <strong className="text-deepteal-700">Lagna</strong>.
          </p>
        </HighlightBox>
      </section>
      ...
      <section id="how-to-calculate">
        ...
        <div className="bg-gradient-to-br from-cream-50 to-cream-100 rounded-2xl p-6 border border-cream-200 shadow-sm mb-6">
          <h3 className="font-bold text-deepteal-800 text-lg mb-4">What Happens Inside the Calculator</h3>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 flex items-center justify-center rounded-full bg-deepteal-600 text-white text-xs font-bold flex-shrink-0">
                1
              </div>
      ...
      <section id="12-lagnas">
        ...
        <div className="bg-gradient-to-br from-warmaccent-50 to-orange-50 rounded-2xl p-6 border border-warmaccent-200 shadow-sm mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-warmaccent-500 to-orange-500 text-white">
              <Zap className="w-6 h-6" />
            </div>
            <h3 className="font-bold text-warmaccent-800 text-xl">Fire Lagnas</h3>
          </div>
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-warmaccent-100 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-warmaccent-200">
                  <th className="text-left p-2 font-bold text-warmaccent-800">Lagna</th>
                  <th className="text-left p-2 font-bold text-warmaccent-800">First Impression</th>
                  <th className="text-left p-2 font-bold text-warmaccent-800">Natural Approach</th>
                  <th className="text-left p-2 font-bold text-warmaccent-800">Life Challenge</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-warmaccent-100">
                  <td className="p-2 font-bold text-deepteal-700">Leo</td>
                ...
                <tr>
                  <td className="p-2 font-bold text-deepteal-700">Sagittarius</td>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-amber-100 overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                <tr className="border-b border-amber-100">
                  <td className="p-2 font-bold text-deepteal-700">Virgo</td>
                ...
                <tr>
                  <td className="p-2 font-bold text-deepteal-700">Capricorn</td>
        ...
        <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-2xl p-6 border border-deepteal-200 shadow-sm mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-deepteal-500 to-deepteal-600 text-white">
              <Sparkles className="w-6 h-6" />
            </div>
            <h3 className="font-bold text-deepteal-800 text-xl">Air Lagnas</h3>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-deepteal-200">
                  <th className="text-left p-2 font-bold text-deepteal-800">Lagna</th>
                  <th className="text-left p-2 font-bold text-deepteal-800">First Impression</th>
                  <th className="text-left p-2 font-bold text-deepteal-800">Natural Approach</th>
                  <th className="text-left p-2 font-bold text-deepteal-800">Life Challenge</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Gemini</td>
                ...
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Libra</td>
                ...
                <tr>
                  <td className="p-2 font-bold text-deepteal-700">Aquarius</td>
        ...
        {/* Water Lagnas */}
        <div className="bg-gradient-to-br from-cream-50 via-deepteal-50 to-cream-50 rounded-2xl p-6 border border-deepteal-200 shadow-sm mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-deepteal-600 to-deepteal-700 text-white">
              <Moon className="w-6 h-6" />
            </div>
            <h3 className="font-bold text-deepteal-800 text-xl">Water Lagnas</h3>
          </div>
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-deepteal-100 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
              ...
              <tbody>
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Cancer</td>
                ...
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Scorpio</td>
      ...
      <section id="lagna-vs-others">
        ...
        <div className="bg-gradient-to-br from-warmaccent-50 to-amber-50 rounded-2xl p-6 border border-warmaccent-200 shadow-sm mb-6">
          <h3 className="font-bold text-warmaccent-800 text-lg mb-4">The Trinity of Self-Understanding</h3>
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-warmaccent-100 overflow-x-auto">
            <ComparisonTable
        ...
        <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-2xl p-6 border border-deepteal-200 shadow-sm mb-6">
          <h3 className="font-bold text-deepteal-800 text-lg mb-4">Real-Life Example: The Three Layers</h3>
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-deepteal-100">
            <p className="text-sm text-gray-700 mb-3">
              <strong className="text-deepteal-700">Scenario:</strong> A person meets someone they're attracted to.
            </p>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-warmaccent-100 text-warmaccent-600 flex-shrink-0 font-bold text-sm">
                  L
                </div>
                <div>
                  <p className="font-semibold text-deepteal-800 text-sm mb-1">Lagna (Libra)</p>
                  <p className="text-xs text-gray-700">Makes them appear charming and diplomatic, so the attraction happens easily.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 flex items-center justify-center rounded-full bg-deepteal-100 text-deepteal-600 flex-shrink-0 font-bold text-sm">
                  M
                </div>
                <div>
                  <p className="font-semibold text-deepteal-800 text-sm mb-1">Moon Sign (Scorpio)</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-deepteal-800 text-sm mb-1">Sun Sign (Capricorn)</p>
                  <p className="text-xs text-gray-700">They're looking for a serious, long-term partner to build a life with.</p>
                </div>
              </div>
            </div>
            <p className="text-xs text-deepteal-600 mt-4 italic font-medium">
        ...
        <HighlightBox type="tip">
          <h4 className="font-bold text-deepteal-800 mb-2">Why You Need All Three</h4>
          <ul className="space-y-1 text-sm text-gray-700 mb-0">
      ...
      <section id="lagna-lord">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          Your <strong className="text-deepteal-700">Lagna Lord</strong> is the planet that rules your Lagna sign. The strength of your Lagna Lord determines how effectively you present yourself to the world.
        </p>

        <div className="bg-gradient-to-br from-deepteal-50 to-deepteal-100 rounded-2xl p-6 border border-deepteal-200 shadow-sm mb-6">
          <h3 className="font-bold text-deepteal-800 text-lg mb-4">Lagna Lord by Sign</h3>
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-deepteal-100 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-deepteal-200">
                  <th className="text-left p-2 font-bold text-deepteal-800">Lagna</th>
                  <th className="text-left p-2 font-bold text-deepteal-800">Ruling Planet (Lagna Lord)</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Aries / Scorpio</td>
                  <td className="p-2 text-gray-700">Mars</td>
                </tr>
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Taurus / Libra</td>
                  <td className="p-2 text-gray-700">Venus</td>
                </tr>
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Gemini / Virgo</td>
                ...
                <tr className="border-b border-deepteal-100">
                  <td className="p-2 font-bold text-deepteal-700">Sagittarius / Pisces</td>
                  <td className="p-2 text-gray-700">Jupiter</td>
                </tr>
                <tr>
                  <td className="p-2 font-bold text-deepteal-700">Capricorn / Aquarius</td>
        ...
        <HighlightBox type="note">
          <h4 className="font-bold text-deepteal-800 mb-2">Lagna Lord Strength</h4>
          <p className="text-sm text-gray-700 mb-2">If your Lagna Lord is:</p>
          <ul className="space-y-1 text-sm text-gray-700 mb-0">
            <li><strong className="text-deepteal-700">Strong (well-placed, benefic):</strong> You appear confident, capable, and reliable.</li>
            <li><strong className="text-warmaccent-700">Weak (debilitated, afflicted):</strong> You may seem unsure, hesitant, or lack natural charisma.</li>
          </ul>
          <p className="text-sm text-deepteal-600 mt-3 mb-0 font-semibold">
        ...
        <div className="bg-gradient-to-br from-warmaccent-50 to-amber-50 rounded-2xl p-6 border border-warmaccent-200 shadow-sm mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-warmaccent-500 to-amber-500 text-white">
              <Gem className="w-6 h-6" />
            </div>
            <h3 className="font-bold text-warmaccent-800 text-xl">Gemstones by Lagna Lord</h3>
          </div>
          <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-warmaccent-100 overflow-x-auto mb-4">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-warmaccent-200">
                  <th className="text-left p-2 font-bold text-warmaccent-800">Lagna</th>
                  <th className="text-left p-2 font-bold text-warmaccent-800">Lagna Lord</th>
                  <th className="text-left p-2 font-bold text-warmaccent-800">Gemstone</th>
                  <th className="text-left p-2 font-bold text-warmaccent-800">Metal</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-warmaccent-100">
        ...
        {/* Mantras */}
        <div className="bg-gradient-to-br from-cream-50 to-deepteal-50 rounded-2xl p-6 border border-deepteal-200 shadow-sm mb-6">
          <h3 className="font-bold text-deepteal-800 text-lg mb-4">Mantras to Strengthen Your Lagna Lord</h3>
          ...
          <div className="space-y-2">
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Aries / Scorpio (Mars):</p>
              <p className="text-xs text-gray-700 italic">Om Kram Kreem Kraum Sah Bhaumaya Namah</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Taurus / Libra (Venus):</p>
              <p className="text-xs text-gray-700 italic">Om Shum Shuklaya Namah</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Gemini / Virgo (Mercury):</p>
              <p className="text-xs text-gray-700 italic">Om Bum Budhaya Namah</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Cancer (Moon):</p>
              <p className="text-xs text-gray-700 italic">Om Shraam Shrim Shaum Sah Chandramase Namah</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Leo (Sun):</p>
              <p className="text-xs text-gray-700 italic">Om Hram Hrim Hrum Sah Suryaya Namah</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Sagittarius / Pisces (Jupiter):</p>
              <p className="text-xs text-gray-700 italic">Om Graam Greem Graum Sah Gurave Namah</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-3 border border-deepteal-100">
              <p className="font-semibold text-deepteal-700 text-sm mb-1">Capricorn / Aquarius (Saturn):</p>
      ...
      <section id="conclusion">
        ...
        <div className="prose prose-lg max-w-none mb-6">
          <p className="text-gray-700 leading-relaxed">
            Your <strong className="text-deepteal-700">Lagna is your life's opening act.</strong>
          </p>
          ...
          <HighlightBox type="tip">
            <h4 className="font-bold text-deepteal-800 mb-2">The Power Lies in Awareness</h4>
            <FeatureList
              variant="star"
              items={[
