  ...
  return (
    <div className="space-y-8">
      ...
      <HighlightBox type="warning">
        <h4 className="font-bold text-saffron-800 mb-2">The Brutal Truth About Manglik Dosha</h4>
      ...
      <section id="what-is-manglik">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          <strong className="text-teal-700">Manglik Dosha (or Mangal Dosha)</strong> is an astrological "affliction" caused by <Link href={`/${locale}/tools/kundli`} className="text-saffron-600 hover:underline">Mars being placed in specific houses</Link> in your birth chart. Mars represents courage, passion, conflict, energy, and aggression—the planet of the warrior, bold and direct, sometimes explosive.
        </p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-saffron-200">
                  <th className="text-left p-2 font-bold text-saffron-800">House</th>
                  <th className="text-left p-2 font-bold text-saffron-800">Governs</th>
                  <th className="text-left p-2 font-bold text-saffron-800">Mars Effect</th>
                  <th className="text-left p-2 font-bold text-saffron-800">Marriage Impact</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">1st (Lagna)</td>
                ...
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">4th House</td>
                ...
                <tr className="border-b border-saffron-100 bg-saffron-100/50">
                  <td className="p-2 font-bold text-saffron-700">7th House</td>
                  <td className="p-2 text-gray-700">Marriage, partnerships</td>
                  <td className="p-2 text-gray-700">Marital conflict</td>
                  <td className="p-2 font-bold text-saffron-700">STRONGEST MANGLIK</td>
                </tr>
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">8th House</td>
                ...
                <tr>
                  <td className="p-2 font-bold text-teal-700">12th House</td>
        ...
        <HighlightBox type="note">
          <p className="text-sm text-gray-700">
            <strong className="text-teal-700">Reality Check:</strong> "Log kehte hain 'Manglik hai toh shadi nahi hogi.'
      ...
      <section id="how-to-check">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          The only way to know for sure is to check your actual birth chart. You need your exact birth date, time, and location—precision matters just like <Link href={`/${locale}/tools/lagna`} className="text-saffron-600 hover:underline">Lagna calculation</Link>.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-teal-800 text-lg mb-2">Generate Birth Chart</h3>
                <p className="text-gray-700 text-sm mb-3">
                  Use our <Link href={`/${locale}/tools/kundli`} className="font-semibold text-teal-700 hover:text-saffron-600 transition-colors">Kundli Calculator</Link> to generate your complete birth chart with all planetary positions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-orange-50 rounded-2xl p-6 border border-saffron-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-saffron-800 text-lg mb-2">Locate Mars Position</h3>
                <p className="text-gray-700 text-sm mb-3">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-teal-800 text-lg mb-2">Verify Strength Level</h3>
                <p className="text-gray-700 text-sm mb-3">
                  Not all Manglik Doshas are equal. Strong Mars (Leo) = Strong dosha. Weak Mars (Libra) = Moderate dosha. Use our <Link href={`/${locale}/tools/manglik`} className="font-semibold text-teal-700 hover:text-saffron-600 transition-colors">Manglik Calculator</Link> for instant analysis.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="mars-placement">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-teal-800 text-lg mb-2">Mars in 1st House (Lagna)</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 space-y-2 border border-teal-100">
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Manglik Status:</strong> YES (Dosha present)</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Effect:</strong> Aggressive, impatient, dominant personality</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Challenge:</strong> Partner may feel overwhelmed by your intensity</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Positive:</strong> Natural protector and initiator</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Marriage Outlook:</strong> Works well with equally strong partner (Fire signs)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-orange-50 rounded-2xl p-6 border border-saffron-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-saffron-800 text-lg mb-2">Mars in 4th House</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 space-y-2 border border-saffron-100">
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Manglik Status:</strong> YES (Dosha present)</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Effect:</strong> Conflict at home, disagreements about family/property</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Challenge:</strong> Home feels like battleground rather than sanctuary</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Positive:</strong> You fight for family welfare</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Marriage Outlook:</strong> Needs calm, diplomatic partner to balance home energy</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-teal-800 text-lg mb-2">Mars in 12th House</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 space-y-2 border border-teal-100">
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Manglik Status:</strong> YES (Dosha present)</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Effect:</strong> Expenses, losses, feeling distant from partner</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Challenge:</strong> Financial strain, emotional distance in marriage</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Positive:</strong> Spiritual depth, sacrifice for others</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Marriage Outlook:</strong> Works if partner shares spiritual values</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <HighlightBox type="tip">
          <p className="text-sm text-gray-700">
            <strong className="text-teal-700">Safe Houses:</strong> Mars in 2nd, 3rd, 5th, 6th, 9th, 10th, or 11th house =
      ...
      <section id="myths-vs-reality">
        ...
        <div className="space-y-4 mb-6">
          ...
          {/* Myth 2 */}
          <div className="bg-gradient-to-br from-saffron-50 to-amber-50 rounded-2xl p-6 border border-saffron-200 shadow-sm">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-saffron-500 to-amber-500 flex-shrink-0 shadow-md">
                <CheckCircle className="w-6 h-6 text-white" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-saffron-800 text-lg mb-2">Myth #2: "Manglik must marry only another Manglik"</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
                  <p className="text-sm text-gray-700 mb-2"><strong className="text-saffron-700">Reality:</strong> PARTIALLY TRUE, but not absolute.</p>
                  <p className="text-xs text-gray-600 italic">
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-amber-50 rounded-2xl p-6 border border-saffron-200 shadow-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-saffron-800 text-lg mb-2">Myth #5: "Manglik is a curse from past life"</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
                  <p className="text-sm text-gray-700 mb-2"><strong className="text-saffron-700">Reality:</strong> SIMPLISTIC. Not a curse, just planetary influence.</p>
                  <p className="text-xs text-gray-600 italic">
      ...
      <section id="marriage-impact">
        ...
        <div className="bg-gradient-to-br from-saffron-50 to-orange-50 rounded-2xl p-6 border border-saffron-200 shadow-sm mb-6">
          <h3 className="font-bold text-saffron-800 text-xl mb-4 flex items-center gap-2">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-saffron-200">
                  <th className="text-left p-2 font-bold text-saffron-800">Factor</th>
                  <th className="text-left p-2 font-bold text-saffron-800">Impact</th>
                  <th className="text-left p-2 font-bold text-saffron-800">Success Rate / Notes</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">Conflict Level</td>
                  <td className="p-2 text-gray-700">Higher than average</td>
                  <td className="p-2 text-gray-700">Requires extra communication</td>
                </tr>
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">Passion</td>
                  <td className="p-2 text-gray-700">Very high</td>
                  <td className="p-2 text-gray-700">Can be positive or explosive</td>
                </tr>
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">Compatibility</td>
                  <td className="p-2 text-gray-700">Depends on other factors</td>
                  <td className="p-2 font-bold text-saffron-700">60-70% success with effort</td>
                </tr>
                <tr className="border-b border-saffron-100">
                  <td className="p-2 font-bold text-teal-700">What Works</td>
                  <td className="p-2 text-gray-700">Mutual respect, patience</td>
                  <td className="p-2 text-gray-700">Both partners committed</td>
                </tr>
                <tr>
                  <td className="p-2 font-bold text-teal-700">Red Flags</td>
          ...
          <div className="mt-4 bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
            <p className="text-sm text-gray-700 mb-2"><strong className="text-saffron-700">Success Formula:</strong></p>
            <FeatureList
              items={[
        ...
        {/* Manglik + Manglik */}
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border-2 border-teal-400 shadow-md mb-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-teal-200">
                  <th className="text-left p-2 font-bold text-teal-800">Factor</th>
                  <th className="text-left p-2 font-bold text-teal-800">Impact</th>
                  <th className="text-left p-2 font-bold text-teal-800">Success Rate / Notes</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-teal-100 bg-teal-100/50">
                  ...
                  <td className="p-2 font-bold text-teal-700">80-90% success rate ✨</td>
                </tr>
                <tr className="border-b border-teal-100">
                  <td className="p-2 font-bold text-teal-700">What Works</td>
                ...
                <tr>
                  <td className="p-2 font-bold text-teal-700">Challenge</td>
          ...
          <div className="mt-4 bg-white/80 backdrop-blur rounded-xl p-4 border border-teal-100">
            <p className="text-sm text-gray-700 mb-2"><strong className="text-teal-700">Why Dual-Manglik Works So Well:</strong></p>
            <ul className="text-sm text-gray-700 space-y-1">
              <li className="flex items-start gap-2">
                <Star className="w-4 h-4 text-teal-600 flex-shrink-0 mt-0.5" />
      ...
      <section id="remedies">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-orange-50 rounded-2xl p-6 border border-saffron-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-saffron-800 text-lg mb-2">Remedy #1: Wear Red Coral (Moonga)</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 space-y-2 border border-saffron-100">
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">How it helps:</strong> Strengthens Mars, channels energy constructively</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Cost:</strong> ₹500-5,000 (affordable)</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">How to wear:</strong> Copper/gold ring on right hand ring finger, Tuesday, with mantra "Om Kram Kreem Kraum Sah Bhaumaya Namah" (108 times)</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Effectiveness:</strong> Moderate to high (50-70% of people)</p>
                  <p className="text-xs text-saffron-600 italic mt-2">⚠️ Consult astrologer before wearing—not suitable for everyone</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-teal-800 text-lg mb-2 flex items-center gap-2">
                  ...
                  <span className="text-xs bg-teal-500 text-white px-2 py-1 rounded-full">MOST EFFECTIVE</span>
                </h3>
                <div className="bg-white/90 backdrop-blur rounded-xl p-4 space-y-2 border border-teal-200">
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">How it helps:</strong> Compatibility IS the remedy; shared chart patterns reduce conflict</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Cost:</strong> FREE</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">What to check:</strong> Partner's Venus/Moon compatibility, <Link href={`/${locale}/tools/marriage-matching`} className="text-saffron-600 hover:underline">Marriage Matching</Link>, 7th house compatibility</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Effectiveness:</strong> HIGHEST (addresses root cause directly)</p>
                  <p className="text-xs text-teal-600 font-bold mt-2">⭐ This is the BEST remedy—better than any gemstone or ritual</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-saffron-50 to-amber-50 rounded-2xl p-6 border border-saffron-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-saffron-800 text-lg mb-2">Remedy #4: Conscious Communication in Marriage</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 space-y-2 border border-saffron-100">
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">How it helps:</strong> Mars = conflict tendency; awareness prevents manifestation</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Cost:</strong> FREE</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">What to practice:</strong> Daily check-ins, express anger before it builds, listen without judgment, use "I feel" statements, weekly relationship reflection</p>
                  <p className="text-sm text-gray-700"><strong className="text-saffron-700">Effectiveness:</strong> HIGHEST (psychological + astrological)</p>
                  <p className="text-xs text-saffron-600 italic mt-2">💡 Awareness + communication fixes Manglik better than expensive rituals</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-teal-800 text-lg mb-2">Remedy #5: Donate Red Items on Tuesdays</h3>
                <div className="bg-white/80 backdrop-blur rounded-xl p-4 space-y-2 border border-teal-100">
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">How it helps:</strong> Donation channels Mars energy toward charity/positive action</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Cost:</strong> FREE to minimal</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">What to donate:</strong> Red cloth, red flowers, red lentils (masoor dal), turmeric</p>
                  <p className="text-sm text-gray-700"><strong className="text-teal-700">Effectiveness:</strong> Moderate (works through karma adjustment)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <HighlightBox type="important">
          <p className="text-sm text-gray-700">
            <strong className="text-teal-700">The Truth:</strong> Don't fall for astrologers selling ₹50,000+ rituals.
      ...
      <section id="conclusion">
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-8 border-2 border-teal-300 shadow-lg mb-6">
          <h3 className="font-bold text-teal-800 text-xl mb-4">Here's What We Know for Certain:</h3>
          <FeatureList
            items={[
        ...
        <div className="bg-gradient-to-br from-saffron-50 to-orange-50 rounded-2xl p-8 border-2 border-saffron-300 shadow-lg mb-6">
          <h3 className="font-bold text-saffron-800 text-xl mb-4">What Actually Prevents Manglik Marriage Problems:</h3>
          <div className="grid md:grid-cols-2 gap-3">
            <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
              <p className="text-sm font-semibold text-saffron-700 mb-1">✓ Choosing compatible partner</p>
              <p className="text-xs text-gray-600">Check Venus/Moon compatibility and <Link href={`/${locale}/tools/marriage-matching`} className="text-saffron-600 hover:underline">Marriage Matching</Link></p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
              <p className="text-sm font-semibold text-saffron-700 mb-1">✓ Emotional maturity</p>
              <p className="text-xs text-gray-600">Both partners handle conflict consciously</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
              <p className="text-sm font-semibold text-saffron-700 mb-1">✓ Communication practice</p>
              <p className="text-xs text-gray-600">Daily check-ins, express feelings early</p>
            </div>
            <div className="bg-white/80 backdrop-blur rounded-xl p-4 border border-saffron-100">
              <p className="text-sm font-semibold text-saffron-700 mb-1">✓ Mars awareness</p>
        ...
        <p className="text-gray-700 text-lg leading-relaxed mb-6">
          Your Manglik Dosha doesn't predict your marriage's fate. <strong className="text-teal-700">Your choices do.</strong>
        </p>

        <p className="text-gray-700 text-lg leading-relaxed">
          Your Manglik Dosha is not your destiny—it's just information. Use it to understand yourself better, choose your
          partner consciously using <Link href={`/${locale}/tools/kundli`} className="text-saffron-600 hover:underline">Kundli analysis</Link>,
          and commit to communication. That's the real remedy. <strong className="text-teal-700">Your marriage is possible.
